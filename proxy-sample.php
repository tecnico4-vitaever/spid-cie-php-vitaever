...
<html>
    <body>
        ...
        <a href="/proxy.php?client_id=692878970e6c8&action=login&redirect_uri=/proxy-sample.php&idp=DEMOVALIDATOR&state=state">Login with a single IdP (example for DEMO Validator)</a>
        <p>
            <?php
        ...
        <a href="/proxy.php?client_id=692878970e6c8&action=logout">Esci</a>
    </body>
</html>
